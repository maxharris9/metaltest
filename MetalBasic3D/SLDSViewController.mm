...
@implementation SLDSViewController
{
@private
    // app control
...
- (void)initCommon
{
    ...
    __block SLDSViewController* weakSelf = self;
...
- (void)viewDidLoad
{
    ...
    SLDSView *renderView = (SLDSView *)self.view;
...
- (void)setPaused:(BOOL)pause
{
    ...
    if(_displayLink)
    {
        ...
        if(pause == YES)
        {
            ...
            [(SLDSView *)self.view releaseTextures];
        }
        else
        {
            _gameLoopPaused = pause;
